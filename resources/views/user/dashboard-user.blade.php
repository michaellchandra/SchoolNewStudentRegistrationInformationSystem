    ...
    <div class="container-fluid">
                ...
                @if ($user->id === $loggedInUser->id)
                    @foreach ($user->registrations as $registration)
                        ...
                        <div class="card-header d-flex justify-content-between py-3 align-items-center">
                            ...
                            <h6 class="m-0 fw-bold text-primary">{{ $pendaftaranAkunStatus }}</h6>
                        </div>
                        <div class="card-header d-flex justify-content-between py-3 align-items-center">

                            <p class="m-0">Pengisian Biodata & Berkas</p>
                            <h6 class="m-0 fw-bold text-primary">{{ $pengisianAdministrasi }}</h6>
                        </div>

                        <div class="card-header d-flex justify-content-between py-3 align-items-center">

                            <p class="m-0">Hasil Tes</p>
                            <h6 class="m-0 fw-bold text-primary">{{ $melakukanTes }}</h6>
                        </div>
                        <div class="card-header d-flex justify-content-between py-3 align-items-center">

                            <p class="m-0">Pembayaran Administrasi</p>
                            <h6 class="m-0 fw-bold text-danger">{{ $pembayaranAdministrasi }}</h6>
                        </div>
                    @endforeach
                @endif
            @endforeach
        ...
        <div class="card shadow mb-4">
            <div class="card-header d-flex flex-column justify-content-between py-3 align-items-start">
                ...
                <div class="mb-3 card">
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore accusamus, at blanditiis inventore
                ...
                <a href="/user/pengisian-biodata" class="btn btn-sm btn-primary w-100 shadow-sm p-2 ">Lanjut</a>
