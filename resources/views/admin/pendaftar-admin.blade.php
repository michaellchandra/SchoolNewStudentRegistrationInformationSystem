                        ...
                        @foreach ($biodata as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- Modal Biodata-->
                                    <div class="modal fade" id="fileModal{{ $data->id }}" tabindex="-1" role="dialog"
                                        aria-labelledby="fileModalLabel{{ $data->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-xl" role="document">
                                            <div class="modal-content p-3">
                                                <div class="modal-header">
                                                    <h5 class="modal-title fw-bold" id="fileModalLabel{{ $data->id }}">
                                                        Berkas
                                                        Biodata</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="card shadow mb-4">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div>
                                                                        <p class="m-0">Nomor Induk Kependudukan (NIK)</p>
                                                                        <p class="fw-bold text-uppercase">
                                                                            {{ $data->nomorNIK }}</p>
                                                                    </div>
                                                                    <div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p class="fw-bold">{{ $data->tinggiBadan }} cm</p>
                                                                    </div>
                                                                    <div>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="card shadow mb-4">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div>
                                                                        <p class="m-0">Penghasilan Ayah Kandung :</p>
                                                                        <p class="fw-bold text-uppercase">
                                                                            {{ $data->penghasilanAyahKandung }}</p>
                                                                    </div>
                                                                    <div>
                                                                        <p class="m-0">Nomor Telepon Ayah Kandung :</p>
                                                                        <p class="fw-bold text-uppercase">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div>
                                                                        <p class="m-0">Nama Ibu Kandung Kandung :</p>
                                                                        <p class="fw-bold text-uppercase">
                                                                    ...
                                                                    <div>
                                                                        <p class="m-0">Nomor Telepon Ibu Kandung :</p>
                                                                        <p class="fw-bold text-uppercase">
                                                    ...
                                                    <div class="col m-0 p-0">
                                                            ...
                                                            <div class="card shadow mb-4">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        @else
                                                                            <span>Belum Upload Berkas Akta Kelahiran</span>
                                                                        @endif
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        @if ($data->berkasKartuKeluarga)
                                                                            <a href="{{ route('admin.biodata.file', ['user_id' => $data->user_id, 'filename' => $data->berkasKartuKeluarga]) }}"
                                                                                ...
                                                                                target="_blank">Lihat Berkas</a>
                                                                        @else
                                                                            <span>Belum Upload Berkas Kartu Keluarga</span>
                                                                        @endif
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        @if ($data->berkasKTPIbuKandung)
                                                                            <a href="{{ route('admin.biodata.file', ['user_id' => $data->user_id, 'filename' => $data->berkasKTPIbuKandung]) }}"
                                                                                ...
                                                                                target="_blank">Lihat Berkas</a>
                                                                        @else
                                                                            <span>Belum Upload Berkas KTP Ibu Kandung</span>
                                                                        @endif
                                                                    </div>
                                                                    <div class="mb-3">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="card shadow mb-4">
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="mb-3">
                                                                        <p class="m-0">Scan Raport Kelas 7 Ganjil</p>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <p class="m-0">Scan Raport Kelas 8 Ganjil</p>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <p class="m-0">Scan Raport Kelas 9 Ganjil</p>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        @if ($data->sertifikatPrestasi)
                                                                            <a href="{{ route('admin.biodata.file', ['user_id' => $data->user_id, 'filename' => $data->sertifikatPrestasi]) }}"
                                                                                ...
                                                                                target="_blank">Lihat Berkas</a>
                                                                        @else
                                                                            <span>Belum Upload Sertifikat Prestasi</span>
                                                                        @endif
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        ...
                                                                        @if ($data->sertifikatSertifikasi)
                                                                            <a href="{{ route('admin.biodata.file', ['user_id' => $data->user_id, 'filename' => $data->sertifikatSertifikasi]) }}"
                                                                                ...
                                                                                target="_blank">Lihat Berkas</a>
                                                                        @else
                                                                            <span>Belum Upload Sertifikat Hasil Sertifikasi
                                                                                Bahasa</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
